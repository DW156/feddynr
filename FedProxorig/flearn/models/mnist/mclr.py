...
class MCLR(nn.Module):
    """Multi-class Logistic Regression model for MNIST"""
...
class Model(nn.Module):
    ...
    def __init__(self, input_dim: int, num_classes: int, optimizer: Optional[optim.Optimizer] = None, seed: int = 1):
        ...
        self.model = MCLR(input_dim, num_classes)
